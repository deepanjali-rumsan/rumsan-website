    ...
    <section className="py-20">
      <Container>
        ...
        <div className="flex flex-wrap justify-center items-end gap-4 md:gap-6">
          ...
          <div className="relative overflow-hidden rounded-3xl flex-shrink-0 w-full sm:w-[240px] lg:w-[260px] h-[320px] transition-transform duration-500 hover:-translate-y-2">
            <Image
          ...
          <div className="relative overflow-hidden rounded-3xl flex-shrink-0 w-full sm:w-[240px] lg:w-[260px] h-[360px] transition-transform duration-500 hover:-translate-y-2">
            <Image
          ...
          <div className="relative overflow-hidden rounded-3xl flex-shrink-0 w-full sm:w-[280px] lg:w-[300px] h-[380px] transition-transform duration-500 hover:-translate-y-2">
            <Image
              ...
              className="object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-450/80 via-blue-500/80 to-purple-600/80"></div>
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
